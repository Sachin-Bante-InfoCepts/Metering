...
import org.pentaho.platform.engine.security.event.MeteringDataProcessor;
...
public class PentahoLogoutHandler implements LogoutHandler {
  ...
  public void logout( final HttpServletRequest request, final HttpServletResponse response,
    ...
    //***Following Code added fro metering - inserting logout time in db
     String loginUserName = userSession.getName();	 
	 MeteringDataProcessor jobObj = new MeteringDataProcessor();
	 jobObj.insertLogOutTime(loginUserName);
    //End 
    ...
    logger.info("\n\n\n*******Inside PentahoLogoutHandler-Pentaho Session Loggedout!!! **********");

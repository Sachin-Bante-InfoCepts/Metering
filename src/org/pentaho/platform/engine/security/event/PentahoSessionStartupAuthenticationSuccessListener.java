  ...
  public void onApplicationEvent( final ApplicationEvent event ) {
    if ( event instanceof InteractiveAuthenticationSuccessEvent || event instanceof AuthenticationSuccessEvent) {
      ...
      try {
        ...
        logger.debug( "\n\n\n*************\nInside PentahoSessionStartupAuthenticationSuccessListener" );
        
        //***Following code added for metering NimbleBI customers
        MeteringDataProcessor obj = new MeteringDataProcessor();
        obj.logDataforMetering();
        //End
